        ...
        <div className="card card-profile">
          <div className="card-avatar">
            <a href="#">
              ...
              <img
                className="img"
                src="../../../../templates/HTML/images/3.png"
                alt=""
              />{' '}
            </a>
          </div>
          <div className="table">
            ...
            <div className="ftr">
              {' '}
              <a href="#" className="btn btn-just-icon btn-pinterest btn-round">
                <i className="fa fa-pinterest"></i>
              </a>{' '}
              <a href="#" className="btn btn-just-icon btn-twitter btn-round">
                <i className="fa fa-twitter"></i>
              </a>{' '}
              <a href="#" className="btn btn-just-icon btn-dribbble btn-round">
