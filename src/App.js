...
library.add(faFacebook, faTwitter, faPhone, faEnvelope, faMarker, faArrowLeft, faArrowRight, faSeedling, faChalkboardTeacher, faNewspaper, faLightbulb, faBook, faMapMarked, faInfoCircle, faSearch)
...
const App = () => (
  ...
  <React.Fragment>
    ...
    <Route path='/' render={() => (< BootstrapNav />)} />
      ...
      <Route exact path='/training/gsep' render={() => (<FeedPage icon={'chalkboard-teacher'} pageName={'Global Science Education Pathways'} pageInitial={'tr-background'} page={'gsep'} description={pageDecriptions.gsep} heroImage={stem}/>)} /> 

      <Route exact path='/training/sea-future-of-work' render={() => (<FeedPage icon={'chalkboard-teacher'} pageName={'SEA Future of Work'} pageInitial={'tr-background'} page={'training'} description={pageDecriptions.training} heroImage={coaching}/>)} /> 
